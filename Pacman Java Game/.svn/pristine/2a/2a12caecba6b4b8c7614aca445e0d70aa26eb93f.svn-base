...
public class ScoreView {
    ...
    public ScoreView(ScoreViewModel viewModel) {
        ...
        var highScoresTitle = new Label("High Scores");
        ...
        var sortByBtn = new Button("Sorting By: ?");
